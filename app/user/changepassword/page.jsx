...
function page() {
  return (
    <div>
      ...
      <div className='text-lg text-center py-10 sm:py-5'>Change Account Password</div>
      <form className='flex flex-col gap-3 sm:items-center mx-auto px-5'>
        ...
        <button className='bg-slate-500/50 sm:w-96 rounded-sm p-2 text-sm' type='submit'>Send Reset Link</button>
      </form>
    </div>
  )
}
